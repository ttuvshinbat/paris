...
function MyNavbar() {
    var toriinDalbaa = <svg width={"20px"} xmlns="http://www.w3.org/2000/svg" fill="#ffd900" id="flag-icons-mn" viewBox="0 0 640 480">
    ...
    return (
        <Navbar className='navbar' expand="lg">
            <Container fluid>
                ...
                <div className='d-flex justify-content-end' >
                    <Nav.Link href="#action1" className='mx-1 fs-6 d-flex justify-content-end'>hel songoh <div >{toriinDalbaa}</div>   </Nav.Link>
